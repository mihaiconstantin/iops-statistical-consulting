...
### Statistical Analyses: General Remarks and Data Preparation

#### A Remark On Bayesian Modeling
...
The first step we need to do is to check whether the model estimation process converged.
