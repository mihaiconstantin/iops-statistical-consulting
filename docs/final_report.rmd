...
```{r}
# Load the dataset.
data.toy <- read.csv("datatoy.csv")
# View the dataset
print(data.toy)
```

While you real data my contain many respondents, this toy data set only contains only 20 respondents.
...
source("./scripts/helpers/constants.R")
