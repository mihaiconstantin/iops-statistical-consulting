...
We provide two functions for performing the data pre-processing required to run the analyses.
...
- column `t1` indicates the frequency for each response pattern at time one, regardless of the treatment group

Ultimately, the pattern-count table `pattern.data` is needed to run the analyses below.
